        ...
        <div className='flex items-center gap-4 '>
          {btns.map((item) => (
            <Button
              ...
              variant='outline'
              className={cn(
                "mt-4 text-sm cursor-pointer hover:bg-[#f2f2f2] dark:hover:bg-[#535353] px-4 text-[15px] border w-fit h-[44px] rounded-lg dark:border-[#383838] border-[#dadada] bg-transparent",
